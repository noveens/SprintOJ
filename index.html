			    ...
			    <div class = "navbar-header">
		      	...
		      	<div class="collapse navbar-collapse" id="navbar-collapse">
		         	<ul class="nav navbar-nav">
				        <li><a href="php/compete.php">Compete</a>
				        <li><a href='php/allsub.php'>All Submissions</a>
				        <li><a href="php/lastsub.php">Last Submissions</a>
				        <li><a href="php/compare.php">Compare</a>
				        <li><a href="http://www.bugecode.com/">Bug-e-Code</a>
				        <li><a href="php/aboutus.php">About Us</a>
					</ul>
		      	</div>
		    </div>
		</nav>
